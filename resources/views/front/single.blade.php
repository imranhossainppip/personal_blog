...
@endsection
@section('content')
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{asset('/front/')}}/images/img_2.jpg');">
      <div class="container">
          ...
          <div class="col-md-12 col-lg-10">
            <div class="post-entry text-center">
              ...
              <div class="post-meta align-items-center text-center">
                <figure class="author-figure mb-0 mr-3 d-inline-block"><img src="{{asset('/front/')}}/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
          ...
          <div class="col-md-12 col-lg-8 main-content">
            ...
            <div class="row mb-5 mt-5">
              <div class="col-md-12 mb-4">
                <img src="{{asset('/front/')}}/images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{asset('/front/')}}/images/img_2.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
              <div class="col-md-6 mb-4">
                <img src="{{asset('/front/')}}/images/img_3.jpg" alt="Image placeholder" class="img-fluid rounded">
              </div>
            </div>
          ...
          <div class="col-md-12 col-lg-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="bio text-center">
                <img src="{{asset('/front/')}}/images/person_2.jpg" alt="Image Placeholder" class="img-fluid mb-5">
                <div class="bio-body">
                  <h2>Craig David</h2>
            ...
            <div class="sidebar-box">
              ...
              <div class="post-entry-sidebar">
                <ul>
                  <li>
                    <a href="">
                      <img src="{{asset('/front/')}}/images/img_1.jpg" alt="Image placeholder" class="mr-4">
                      <div class="text">
                  ...
                  <li>
                    <a href="">
                      <img src="{{asset('/front/')}}/images/img_2.jpg" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                          <span class="mr-2">March 15, 2018 </span>
                  ...
                  <li>
                    <a href="">
                      <img src="{{asset('/front/')}}/images/img_3.jpg" alt="Image placeholder" class="mr-4">
                      <div class="text">
                        <h4>There’s a Cool New Way for Men to Wear Socks and Sandals</h4>
                        <div class="post-meta">
                          <span class="mr-2">March 15, 2018 </span>
